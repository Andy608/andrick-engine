...
namespace bb
{
	...
	public:
		...
		static andrick::Image* mspBrickworkHeightMap;
		static andrick::Image* mspBrickworkNormalMap;

		static andrick::Image* mspConcreteHeightMap;
		static andrick::Image* mspConcreteNormalMap;
